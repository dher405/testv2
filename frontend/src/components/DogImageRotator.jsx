...
const dogImages = [
  ...
  "https://images.dog.ceo/breeds/dachshund/n02088364_1000.jpg",
...
function DogImageRotator() {
  const imagesPerGroup = Math.floor(dogImages.length / GROUPS);
  const groups = Array.from({ length: GROUPS }, (_, i) =>
    dogImages.slice(i * imagesPerGroup, (i + 1) * imagesPerGroup)
  );
  ...
  return (
    <div style={{
      ...
      <p style={{ color: '#00ff00', fontSize: '14px' }}>
        ⭐ Pictures rotate every 15 minutes! Bookmark this page! ⭐
      </p>
